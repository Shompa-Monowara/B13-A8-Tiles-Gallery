...
const Footer = () => {
  return (
    <footer className="relative mt-24 bg-[#16171E] text-white">
      <div className="h-px w-full bg-linear-to-r from-transparent via-white/10 to-transparent" />

      {/* Background decoration gradient */}
      <div
        className="absolute inset-0 -z-10 bg-linear-to-tr 
        from-[#6D1731]/5 via-transparent to-[#D5B471]/5 
        dark:from-[#6D1731]/10 dark:to-[#D5B471]/10 blur-3xl"
      />
          ...
          <div className="flex-1 max-w-sm space-y-4">
            ...
            <div className="w-11 h-11  flex items-center justify-center  flex-shrink-0">
              ...
              <h3 className="font-black text-xl tracking-wider uppercase text-white">
                Tiles<span className="text-[#D5B471] font-light">Gallery</span>
              </h3>
            </Link>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-5 text-lg text-gray-400">
              <Link 
                ...
                aria-label="Facebook" 
                className="hover:text-[#D5B471] transition-colors"
              >
                <FaFacebook />
              </Link>
              <Link 
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              <li className="flex items-center gap-3">
                <FaMapMarkerAlt className="text-[#D5B471] flex-shrink-0" />
                <span>Dhaka, Bangladesh</span>
              </li>
              <li className="flex items-center gap-3">
                <FaPhoneAlt className="text-[#D5B471] flex-shrink-0" />
                <a href="tel:+880123456789" className="hover:text-white transition-colors">
                  +880 1234-567890
                </a>
              </li>
              <li className="flex items-center gap-3">
                <FaEnvelope className="text-[#D5B471] flex-shrink-0" />
                <a href="mailto:support@tilesgallery.com" className="hover:text-white transition-colors">
